          ...
          <Box borderWidth="1px" borderRadius="lg" p={4} shadow="md" bg="gray.800" borderColor="gray.700">
            ...
            <Table variant="simple" size="sm" colorScheme="whiteAlpha">
              <Thead>
                <Tr>
                  <Th color="gray.100">順位</Th>
                  <Th color="gray.100">チーム名</Th>
                  <Th color="gray.100">勝利数</Th>
                  <Th color="gray.100">レース数</Th>
                ...
                {overallRankings.length > 0 ? (
                  overallRankings.map((entry) => (
                    <Tr key={entry.position}>
                      ...
                      <Td>
                        <Text color="white" fontSize="lg" fontWeight="semibold">{entry.teamName || entry.playerName}</Text>
                      </Td>
                      <Td color="white">{entry.wins}</Td>
                      <Td color="white">{entry.races}</Td>
                      <Td>
                        {entry.bestTime && (
